...
KinveyRequestObject = require '../../lib/request-builder.coffee'

describe 'Business Logic Tester / request object builder', () ->
  it 'tester.createRequestObject creates an instance of KinveyRequestObject', (done) ->
    tester.createRequestObject().should.be.an.instanceof KinveyRequestObject
    done()

  it 'starts as an empty request object', (done) ->
    requestObject = new KinveyRequestObject()

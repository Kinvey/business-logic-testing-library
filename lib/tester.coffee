...
KinveyRequestObject = require './request-builder'
KinveyResponseObject = require './response-builder'
...
runBLCodeString = (blCodeString, isCollectionHook, collectionOrEndpointName, blFunctionName, request, response, callback) ->
  ...
  if request instanceof KinveyRequestObject
  ...
  if response instanceof KinveyResponseObject
...
module.exports =
  ...
  createRequestObject: (fromJSON) ->
    return new KinveyRequestObject fromJSON

  createResponseObject: (fromJSON) ->
    return new KinveyResponseObject fromJSON
